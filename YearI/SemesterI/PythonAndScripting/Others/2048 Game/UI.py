...
class Game2048(Frame):
    ...
    def init_matrix(self):
        '''
        To start the game and intialize the matrix.
        '''
    ...
    def update_grid_cells(self):
        '''
        Updating the empty grid cells when the board is changed.
        '''
        for i in range(c.GRID_LEN):
            for j in range(c.GRID_LEN):
        ...
        # call the update_idletasks() method on any widget.
        self.update_idletasks()

    def key_down(self, event):
        '''
        When any key is pressed, an event is created.
        '''
        key = repr(event.char)
